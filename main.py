    ...
    await nexus.publish(
        ...
        [{
            ...
            "intents": [
                {
                    "name": "search.fact",
                    "description": "Recherche d'un fait, d'une définition, d'une personne ou d'un lieu",
                    "examples": [
                        "Qui est Emmanuel Macron ?",
                        "Quelle est la capitale de l'Australie ?",
                        "C'est quoi le CRISPR ?",
                        "Qui a inventé Internet ?",
                        "Quelle est la superficie de la France ?",
                        "Qu'est-ce que la blockchain ?",
                        "Combien d'habitants en Chine ?",
                    ],
                    "payload": {"query": "{query}", "categories": "general"},
                },
                {
                    "name": "search.event",
                    "description": "Recherche sur un événement récent ou une actualité ciblée et précise",
                    "examples": [
                        "Que s'est-il passé en Ukraine récemment ?",
                        "Dernières nouvelles sur le conflit au Moyen-Orient",
                        "Résultats des élections françaises",
                        "Qu'est-ce qui se passe avec l'euro ?",
                        "Actualité sur Elon Musk",
                        "Derniers développements en Syrie",
                        "Que se passe-t-il avec OpenAI ?",
                    ],
                    "payload": {"query": "{query}", "categories": "news"},
                },
                {
                    "name": "search.science",
                    "description": "Recherche sur un sujet scientifique, médical ou naturel",
                    "examples": [
                        "Comment fonctionne la fusion nucléaire ?",
                        "Qu'est-ce que la photosynthèse ?",
                        "Quels sont les effets du café sur le corps ?",
                    ...
                    "payload": {"query": "{query}", "categories": "science"},
                },
                {
                    "name": "search.tech",
                    "description": "Recherche sur la technologie, l'informatique, un produit ou un logiciel",
                    "examples": [
                        "Quelles sont les nouveautés de l'iPhone 17 ?",
                        "Comment installer Python sur Windows ?",
                        "Quelle est la différence entre RAM et ROM ?",
                        "C'est quoi Docker ?",
                        "Dernier modèle de GPU Nvidia",
                        "Comment fonctionne le Wi-Fi 7 ?",
                        "Qu'est-ce que Kubernetes ?",
                    ],
                    "payload": {"query": "{query}", "categories": "it"},
                },
            ],
        }],
    )
